...
@section('content')
    <div class="container mt-5">
        ...
        <form action="{{ route('dashboard.user.application.writer.send-request') }}" enctype="multipart/form-data" method="post">
            @csrf @method('POST')
            <div class="row">
                ...
                <div class=" form-group col-xl-6 col-lg-6 col-md-12 col-sm-12 mt-2">
                    ...
                    <input type="number" class=" form-control  @error('yrs_of_expirience') is-invalid @enderror" name="yrs_of_expirience">
