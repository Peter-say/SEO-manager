                ...
                <div class="row">
                    @foreach ($blogs as $blog)
                        <div class=" blog-index-content-area col-xl-4 col-lg-4 col-md-6 col-sm-6 mb-5">
                            <h4><a href="{{ route('web.blog', $blog->id) }}" rel="noopener noreferrer">{{ Str::limit($blog->blog_title, 50) }}</a>
                            </h4>
                            <div class="index-content-area">
                                <img class="img-fluid" src="{{asset('ImageFolder/'.$blog->cover_image ?? 'assets/img/elements/5.jpg')}}" alt="">
